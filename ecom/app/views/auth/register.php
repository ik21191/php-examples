<div class="max-w-md mx-auto bg-white p-8 rounded-xl shadow-sm border border-gray-100 mt-10">
    ...
    <form action="/customer/register-user" method="POST" class="space-y-4">
        <div>
    ...
    <p class="text-sm text-center text-gray-500 mt-4">Already have an account? <a href="/customer/login-form" class="text-blue-600 hover:underline">Log in</a></p>
</div>
