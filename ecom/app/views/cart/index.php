...
<?php if (empty($cartItems)): ?>
    <div class="bg-white p-8 rounded-xl text-center shadow-sm max-w-md mx-auto">
        ...
        <a href="/" class="inline-block bg-blue-600 text-white font-medium px-6 py-2 rounded-lg hover:bg-blue-700">Go Shopping</a>
    </div>
<?php else: ?>
    <div class="flex flex-col lg:flex-row gap-8">
            ...
            ?>
                <div class="flex items-center justify-between border-b border-gray-100 pb-4 last:border-0 last:pb-0">
                    ...
                    <div class="text-right">
                        ...
                        <a href="/customer/remove-cart-item?id=<?= $id ?>" class="text-xs text-red-500 hover:underline">Remove</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="w-full lg:w-1/3 bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-fit">
            ...
            <?php else: ?>
                <a href="/customer/login-form" class="block w-full text-center bg-gray-800 hover:bg-gray-900 text-white font-bold py-3 px-4 rounded-lg transition shadow-md">
                    Login to Checkout
                </a>
            <?php endif; ?>
        </div>
