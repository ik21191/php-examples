<div class="max-w-md mx-auto bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden mt-10">
    ...
    <div class="p-6">
        ...
        <form action="/customer/checkout-verify" method="POST" class="space-y-4">
            ...
            <div class="pt-4 flex flex-col space-y-2">
                ...
                <a href="/customer/cart" class="w-full text-center bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-2.5 rounded-xl transition text-xs">
