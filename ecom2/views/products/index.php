        ...
        <?php foreach ($products as $product): ?>
            ...
            <div class="product-catalog-card bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col transition duration-200 hover:shadow-md" 
                ...
                <div class="h-48 overflow-hidden bg-gray-100 relative">
                    ...
                    <a href="index.php?controller=product&action=details&id=<?= $product['id'] ?>">
                ...
                <div class="p-5 flex-grow flex flex-col justify-between">
                    <div>
                        ...
                        <!-- WRAP THE TITLE IN A ROUTING LINK -->
                            <a href="index.php?controller=product&action=details&id=<?= $product['id'] ?>" class="hover:text-blue-600 transition">
                    ...
                    <div class="mt-4">
                        <a href="index.php?controller=cart&action=add&id=<?= $product['id'] ?>" class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-4 rounded-lg transition shadow-sm text-sm">
                            Add to Cart 🛒
                        </a>
                    </div>
                </div>
