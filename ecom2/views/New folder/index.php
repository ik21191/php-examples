...
<div class="max-w-6xl mx-auto">
    ...
    <?php if (empty($products)): ?>
        <div class="bg-white rounded-2xl border border-gray-100 p-12 text-center shadow-sm max-w-md mx-auto">
            ...
            <a href="index.php" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold text-sm px-6 py-2.5 rounded-xl transition shadow">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php foreach ($products as $product): ?>
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col transition duration-200 hover:shadow-md relative">
                    ...
                    <a href="index.php?controller=wishlist&action=toggle&id=<?= $product['id'] ?>" class="absolute top-3 right-3 bg-white/80 backdrop-blur shadow-sm p-1.5 rounded-full hover:bg-white transition text-sm">
                        ❤️
                    </a>
                    ...
                    <div class="p-5 flex-grow flex flex-col justify-between">
                        ...
                        <div class="mt-4">
                            <a href="index.php?controller=cart&action=add&id=<?= $product['id'] ?>" class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 rounded-xl transition text-sm shadow-sm">
                                Move to Cart 🛒
                            </a>
                        </div>
                    </div>
