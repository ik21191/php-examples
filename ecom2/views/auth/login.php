<div class="max-w-md mx-auto bg-white p-8 rounded-xl shadow-sm border border-gray-100 mt-10">
    ...
    <p class="text-sm text-center text-gray-500 mt-4">New here? <a href="index.php?controller=auth&action=register" class="text-blue-600 hover:underline">Create an account</a></p>
</div>
